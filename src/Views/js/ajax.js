...
formularios_ajax.forEach(formularios => {   
    ...
    formularios.addEventListener("submit", function (e) {
        ...
        Swal.fire({
            title: '¿Estás seguro?',
            html: "Quieres realizar la acción solicitada",
            icon: 'question',
...
const formularios_ajax2 = document.querySelectorAll(".FormularioAjax2");

formularios_ajax2.forEach(formularios => {   
    // Obtener referencias al select 
    ...
    formularios.addEventListener("submit", function (e) {
        ...
        Swal.fire({
            title: '¿Estás seguro?',
            html: "Quieres realizar la acción solicitada <br> Placa: ",
            icon: 'question',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
